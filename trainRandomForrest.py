...
def train_and_evaluate(data, group_col):
    ...
    return results, feature_importances, explained_variance

experiment_results, experiment_feature_importances, experiment_explained_variance = train_and_evaluate(data, 'Experiment')
vegetation_results, vegetation_feature_importances, vegetation_explained_variance = train_and_evaluate(data, 'Vegetation')
